...
alphas, betas, sigmaMatrix, stdAlphas, testPortfolio, pValuePortfolio, testIndividual, pValueIndividual, marketSharpeRatio, rmsAlphaCAPM, arivCAPM = grs.estimate_capm(factors['Mkt-RF'], returns)
result = pd.DataFrame({
